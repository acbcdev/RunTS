...
import { useConfigStore, type Radius } from "@/store/config";
import { useEditorStore } from "@/store/editor";
import { themes } from "@/themes";
import { useEffect } from "react";
const radiuses: Radius[] = ['0', '0.3', '0.5', '0.8', '1']
          ...
          <div className="grid grid-cols-2 gap-3 cursor-pointer">
            {Object.entries(themes).map(([key, value]) => (
              ...
              <div
                translate="no"
                key={key}
                className={cn(theme === key ? 'border-accent' : 'border-border', "border rounded-lg p-3")}
                style={{
