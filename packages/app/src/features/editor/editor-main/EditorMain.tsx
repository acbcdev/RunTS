...
export function EditorMain({ tab }: EditorMainProps) {
	...
	const handleEditorDidMount = useCallback(
		async (editor: editor.IStandaloneCodeEditor, monacoInstance: Monaco) => {
			...
			editor.addCommand(
				monacoInstance.KeyMod.CtrlCmd | monacoInstance.KeyMod.Alt | monacoInstance.KeyCode.KeyT,
				() => newTab(),
			);
			editor.addAction({
				id: "new-tab",
			...
			editor.addCommand(
				monacoInstance.KeyMod.CtrlCmd | monacoInstance.KeyMod.Alt | monacoInstance.KeyMod.Shift | monacoInstance.KeyCode.KeyT,
				() => {
					const tab = undo();
					if (tab) addTab(tab);
				},
